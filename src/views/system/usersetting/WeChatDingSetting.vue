  ...
  <div :class="[`${prefixCls}`]">
    ...
    <div class="account-row-item">
      ...
      <span>
        ...
        <span class="gray-75" style="margin-left: 8px" v-if="bindDingData.realname">
          {{ '已绑定：' + bindDingData.realname }}
        </span>
        <span class="blue-e5 pointer" style="margin-left: 24px" @click="dingDingBind">
    ...
    <div class="account-row-item">
      ...
      <span>
        <WechatFilled
          :style="!bindWechatData.sysUserId ? { color: '#9e9e9e' } : { color: '#1ec563' }"
          class="item-icon"
        />
        <span class="gray-75" style="margin-left: 12px">微信</span>
        <span class="gray-75" style="margin-left: 8px" v-if="bindWechatData.realname">
          {{ '已绑定：' + bindWechatData.realname }}
        </span>
        <span class="blue-e5 pointer" style="margin-left: 24px" @click="wechatBind">
