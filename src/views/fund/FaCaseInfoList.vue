...
<!--        <a-button type="primary" v-auth="'casefiles:fa_case_info:add'" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>-->
        <a-button  type="primary" v-auth="'casefiles:fa_case_info:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
        <j-upload-button type="primary" v-auth="'casefiles:fa_case_info:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'casefiles:fa_case_info:deleteBatch'">批量操作
