...
export const getParseStandardEntityApi = (params) =>
  defHttp.post({ url: '/fa/caseStandardData/getParseStandardEntityList', params })
export const getParseStandardTransApi = (params) =>
  defHttp.post({ url: '/fa/caseStandardData/getParseStandardTransList', params })
export const getParseStandardOrderApi = (params) =>
  defHttp.post({ url: '/fa/caseStandardData/getParseStandardOrderList', params })

export const updateInvolvedPersonApi = (params) =>
  defHttp.post({ url: '/fa/caseInvolved/saveOrUpdateInvolvedRelation', params })
...
export const standardSheetPageListApi = (params) =>
  defHttp.get({ url: '/fa/caseStandardData/standardDataList', params })
...
// 通过文件id查询文件属性信息
export const queryFilePropertyByFileIdApi = (params) =>
  defHttp.post({ url: '/fa/casefile/queryFilePropertyByFileId', params })
