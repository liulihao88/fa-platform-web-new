<template>
  <a-card class="case-body">
    <a-card class="case-body">
      <a-row>
        <a-col span="6">案件名称：{{ caseInfo.caseName }}</a-col>
        <a-col span="6">部门受案号: {{ caseInfo.departmentCaseNumber }}</a-col>
        <a-col span="6">受理日期：{{ formattedAcceptTime }}</a-col>
        <a-col span="6">
          <div class="reason-box">
            <div class="info-label" style="margin-right: 4px">案由:</div>
            <gLocalTooltip :content="caseInfo.caseReason"></gLocalTooltip>
          </div>
        </a-col>
      </a-row>
    </a-card>
