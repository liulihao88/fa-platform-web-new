              ...
              <a-col :xxl="4" :xl="6" :lg="6" :md="6" :sm="12" :xs="24">
                <a-card class="add-knowledge-card" :bodyStyle="cardBodyStyle">
                  ...
                  <div class="add-knowledge-doc" @click="handleCreateUpload">
                    <Icon icon="ant-design:cloud-upload-outlined" size="13"></Icon>
                    <span>文件上传</span>
                  </div>
                  <div class="add-knowledge-doc">
                    ...
                    >
                      <div style="display: flex; width: 100%">
                        <Icon
                          style="margin-left: 0; color: #676f83"
          ...
          <div v-if="selectedKey === 'hitTest'" style="padding: 16px">
            <a-spin :spinning="spinning">
              ...
              <div class="content">
                ...
                <div class="content-card">
                  ...
                  <div v-else-if="notHit">
                    <a-empty
                      :image-style="{ margin: '0 auto', height: '160px', verticalAlign: 'middle', borderStyle: 'none' }"
                    >
              ...
              <div class="hit-test-footer">
                <a-input
                  v-model:value="hitText"
                  size="large"
                  placeholder="请输入"
                  style="width: 100%"
                  @pressEnter="hitTestClick"
                >
                  <template #suffix>
                    <Icon
                      icon="ant-design:send-outlined"
                      style="transform: rotate(-33deg); cursor: pointer"
                      size="22"
                      @click="hitTestClick"
                    ></Icon>
                  </template>
...
import {
  knowledgeDocList,
  knowledgeDeleteBatchDoc,
  knowledgeDeleteAllDoc,
  knowledgeRebuildDoc,
  knowledgeEmbeddingHitTest,
} from '../AiKnowledgeBase.api'
      ...
      if (hitText.value) {
        ...
        knowledgeEmbeddingHitTest({
          ...
          .then((res) => {
            ...
            avatar.value = userStore.getUserInfo.avatar
              ? getFileAccessHttpUrl(userStore.getUserInfo.avatar)
              : defaultImg
            hitText.value = ''
