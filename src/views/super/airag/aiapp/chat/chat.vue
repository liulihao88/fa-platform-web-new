    ...
    <div class="content">
      <div class="header-title" v-if="type === 'view' && headerTitle">
        ...
        <div v-if="showAdvertising" class="header-advertisint">
          AI客服由
          <a
            style="color: #4183c4; margin-left: 2px; margin-right: 2px"
            href="https://www.qiaoqiaoyun.com/aiCustomerService"
            target="_blank"
          >
            敲敲云
          </a>
            ...
            <div class="textarea-bottom">
              ...
              <a-button v-if="loading" type="primary" danger @click="handleStopChat" class="stopBtn">
                ...
                >
                  ...
                  ></path>
                  <path
                    d="M341.333333 341.333333h341.333334v341.333334H341.333333z"
                    fill="currentColor"
                    p-id="5216"
                  ></path>
                </svg>
...
const conversationList = computed(() =>
  chatData.value.filter((item) => item.inversion != 'user' && !!item.conversationOptions),
)
