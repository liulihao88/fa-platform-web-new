  ...
  <div class="model-params-popover">
    ...
    <div class="setting-item" v-if="type === 'model'">
      ...
      <a-space>
        ...
        <a-slider
          v-bind="temperatureProps"
          v-model:value="model.temperature"
          :disabled="model['temperature'] === null"
        />
        <a-input-number
          v-bind="temperatureProps"
          v-model:value="model.temperature"
    ...
    <div class="setting-item" v-if="type === 'model'">
      ...
      <a-space>
        ...
        <a-slider
          v-bind="presencePenaltyProps"
          v-model:value="model.presencePenalty"
          :disabled="model['presencePenalty'] === null"
        />
        <a-input-number
          v-bind="presencePenaltyProps"
          v-model:value="model.presencePenalty"
    ...
    <div class="setting-item" v-if="type === 'model'">
      ...
      <a-space>
        ...
        <a-slider
          v-bind="frequencyPenaltyProps"
          v-model:value="model.frequencyPenalty"
          :disabled="model['frequencyPenalty'] === null"
        />
        <a-input-number
          v-bind="frequencyPenaltyProps"
          v-model:value="model.frequencyPenalty"
    ...
    <div class="setting-item" v-if="type === 'model'">
      ...
      <a-space>
        ...
        <a-input-number
          v-bind="maxTokensProps"
          v-model:value="model.maxTokens"
          :disabled="model['maxTokens'] === null"
        />
      </a-space>
    </div>
    <!-- top k -->
    <div class="setting-item" v-if="type === 'knowledge'">
      ...
      <a-space>
        ...
        <a-input-number
          v-bind="topNumberProps"
          v-model:value="model.topNumber"
          :disabled="model['topNumber'] === null"
        />
      </a-space>
    </div>
    <!-- Score 阈值 -->
    <div class="setting-item" v-if="type === 'knowledge'">
      ...
      <a-space>
        ...
        <a-input-number
          v-bind="similarityProps"
          v-model:value="model.similarity"
          :disabled="model['similarity'] === null"
        />
      </a-space>
    </div>
  </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const tips = {
      temperature:
        '值越大，回复内容越赋有多样性创造性、随机性；设为0根据事实回答，希望得到精准答案应该降低该参数；日常聊天建议0.5-0.8。',
