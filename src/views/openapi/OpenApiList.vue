<template>
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" @expand="handleExpand">
      ...
      <!--插槽:table标题-->
      <template #tableTitle>
        <a-button type="primary" v-auth="'openapi:open_api:add'" @click="handleAdd" preIcon="ant-design:plus-outlined">
          新增
        </a-button>
        <a-button
          type="primary"
          v-auth="'openapi:open_api:exportXls'"
        ...
        <j-upload-button
          type="primary"
          v-auth="'openapi:open_api:importExcel'"
