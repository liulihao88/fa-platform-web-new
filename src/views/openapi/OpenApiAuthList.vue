  ...
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        <a-button
          type="primary"
          v-auth="'openapi:open_api_auth:add'"
          @click="handleAdd"
        ...
        <a-button
          type="primary"
          v-auth="'openapi:open_api_auth:exportXls'"
        ...
        <j-upload-button
          type="primary"
          v-auth="'openapi:open_api_auth:importExcel'"
...
const [registerTable, { reload, updateTableDataRecord, getDataSource }, { rowSelection, selectedRowKeys }] =
  tableContext
