<template>
  <div class="JSelectOrgsConfig">
    ...
    <a-form-item>
      <OrgsConfigModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" />
    </a-form-item>
    <!-- update-end--author:liaozhiyang---date:20240515---for：【QQYUN-9260】必填模式下会影响到弹窗内antd组件的样式 -->
  </div>
</template>
<script lang="ts">
import OrgsConfigModal from './modal/OrgsConfigModal.vue'
...
import './JSelectOrgsConfig.less'

export default defineComponent({
  name: 'JSelectOrgsConfig',
  components: {
    OrgsConfigModal,
    JSelectBiz,
  },
