            ...
            <a-col :md="8" :sm="8" v-if="showAdvancedButton">
              <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
                <a-col :lg="6">
                  ...
                  <a-button preIcon="ant-design:reload-outlined" @click="searchReset" style="margin-left: 8px">
                    重置
                  </a-button>
...
export default defineComponent({
  ...
  components: {
    //此处需要异步加载BasicTable
    BasicModal,
    SearchFormItem: createAsyncComponent(() => import('/@/components/jeecg/OnLine/SearchFormItem.vue'), {
      loading: false,
    }),
